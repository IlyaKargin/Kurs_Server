...
SUITE(Logger){
    ...
    TEST(Logger_nonWriteable){
        Logger l;
        auto result = l.Initialize("logs_nonWriteable");
        CHECK(!result);
    }
}
...
SUITE(Communication){
    ...
    TEST(Communication_portInUse){
        
        Communication com1;
        com1.createSocket(33333);
        
        Communication com2;
        CHECK_THROW(com2.createSocket(33333),ServerError);
    }
}
